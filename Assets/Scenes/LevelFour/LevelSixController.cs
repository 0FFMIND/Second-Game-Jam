...
public class LevelSixController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (timer > 83f && Mouse[19] != null)
        {
            Mouse[19].SetActive(true);
        }
        if (timer > 85f && Mouse[20] != null)
        {
            Mouse[20].SetActive(true);
        }
        if (timer > 87f && Mouse[21] != null)
        {
            Mouse[21].SetActive(true);
        }
        if (timer > 88f && Mouse[22] != null)
        {
            Mouse[22].SetActive(true);
        }
        if (timer > 90f && Mouse[23] != null)
        {
            Mouse[23].SetActive(true);
        }
        if (timer > 92f && Mouse[24] != null)
        {
            Mouse[24].SetActive(true);
        }
        if (timer > 92f && Mouse[25] != null)
        {
            Mouse[25].SetActive(true);
        }
        if (timer > 97f && Mouse[26] != null)
        {
            Mouse[26].SetActive(true);
        }
        if (timer > 98f && Mouse[27] != null)
        {
            Mouse[27].SetActive(true);
        }
        if (timer > 98f && Mouse[28] != null)
        {
            Mouse[28].SetActive(true);
        }
        if (timer > 99f && Mouse[29] != null)
        {
            Mouse[29].SetActive(true);
        }
        ...
        if (isStarOne && isStarTwo && isStarThree && !SaveManager.Instance.isLevelSixEnd)
        {
            SaveManager.Instance.isLevelSixEnd = true;
