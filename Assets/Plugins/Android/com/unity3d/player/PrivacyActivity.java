...
public class PrivacyActivity extends Activity implements DialogInterface.OnClickListener {
    ...
    String privacyUrl = "https://note.youdao.com/s/2k0A4W9i";
    final String htmlStr = "欢迎使用本游戏，在使用本游戏前，请您充分阅读并理解<a href=\"https://note.youdao.com/s/2k0A4W9i\">《用户协议》</a>和<a href=\"https://note.youdao.com/s/2k0A4W9i\">《隐私政策》</a>各条\n" +
    ...
    private void ShowPrivacyDialog(){
        ...
        privacyDialog.setTitle("用户权限与隐私政策");
